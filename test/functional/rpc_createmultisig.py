...
class RpcCreateMultiSigTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        # Runebase registers createmultisig as a wallet RPC (src/wallet/rpc/addresses.cpp),
    ...
    def test_multisig_script_limit(self):
        ...
        # Disabled: Runebase's MAX_SCRIPT_ELEMENT_SIZE is 128000 (not Bitcoin's 520),
    ...
    def do_multisig(self, nkeys, nsigs, output_type):
        ...
        if output_type == 'bech32':
            assert_equal(madd[0:4], "rcrt")  # actually a bech32 address
