...
from test_framework.runebase import generatesynchronized, convert_btc_bech32_address_to_runebase
...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        non_hd_add = convert_btc_bech32_address_to_runebase('bcrt1qmevj8zfx0wdvp05cqwkmr6mxkfx60yezwjksmt')
