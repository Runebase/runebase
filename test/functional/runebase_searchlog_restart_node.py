...
from test_framework.runebaseconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class RunebaseRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    RunebaseRPCSearchlogsTestModified(__file__).main()
