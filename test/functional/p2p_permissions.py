...
from test_framework.runebase import convert_btc_bech32_address_to_runebase, generatesynchronized
...
class P2PPermissionsTests(BitcoinTestFramework):
    ...
    def check_tx_relay(self):
        block_op_true = self.nodes[0].getblock(generatesynchronized(self.nodes[0], COINBASE_MATURITY+1, convert_btc_bech32_address_to_runebase(ADDRESS_BCRT1_P2WSH_OP_TRUE), self.nodes)[0])
        ...
        tx = tx_from_hex(
            self.nodes[0].createrawtransaction(
                inputs=[{
                    ...
                    convert_btc_bech32_address_to_runebase(ADDRESS_BCRT1_P2WSH_OP_TRUE): 5,
                }],
                replaceable=False),
        )
