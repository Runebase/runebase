...
class RunebaseQRC20Test(BitcoinTestFramework):
        ...
        """
            ...
            */
            contract QRC20Token is SafeMath {
                ...
                uint8 public constant decimals = 8; // it's recommended to set decimals to 8 in RUNEBASE
...
if __name__ == '__main__':
    RunebaseQRC20Test(__file__).main()
