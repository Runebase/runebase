...
from test_framework.runebaseconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"runebase-cli -h\" for help or \"runebase-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `runebase-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and runebase-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and runebase-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (RUNEBASE/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (RUNEBASE/kvB)']), network_info['relayfee'])
