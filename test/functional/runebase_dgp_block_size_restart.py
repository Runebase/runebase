...
class RunebaseDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the runebased to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    RunebaseDGPActivation(__file__).main()
