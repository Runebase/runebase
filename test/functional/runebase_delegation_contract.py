...
class RunebaseSimpleDelegationContractTest(BitcoinTestFramework):
    ...
    """
        - Check that it is not possible to use an input with less value than 100 runebase as the first input to the coinstake.
        - Check that 100 runebase is just enough for the first input to the coinstake.
    """
    ...
    def run_test(self):
        ...
        print("nas_staker_must_be_100_runebase_test")
        self.nas_staker_must_be_100_runebase_test()
        self.sync_all()
...
if __name__ == '__main__':
    RunebaseSimpleDelegationContractTest(__file__).main()
