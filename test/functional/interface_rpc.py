...
class RPCInterfaceTest(BitcoinTestFramework):
    ...
    def test_http_status_codes(self):
        ...
        expect_http_rpc_status(204, None,                   self.nodes[0], "generatetoaddress", [1, convert_btc_bech32_address_to_runebase("bcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqdku202")],  2, True)
