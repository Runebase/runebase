...
EXTENDED_SCRIPTS = [
    ...
    'runebase_evm_pectra_activation.py',
...
BASE_SCRIPTS = [
    ...
    'runebase_evm_cancun_gas_usage.py',
    'runebase_dgp.py',
    'runebase_rip1_gas_price.py',
    'runebase_pos.py',
    'runebase_opcall.py',
    ...
    'p2p_runebase_punish_invalid_contract_tx.py',
    ...
    'runebase_evm_pectra_precompiles.py',
