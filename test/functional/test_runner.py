...
EXTENDED_SCRIPTS = [
    ...
    'runebase_evm_london_activation.py --legacy-wallet',
    'runebase_evm_shanghai_activation.py --legacy-wallet',
    'runebase_evm_cancun_activation.py --legacy-wallet',
    'runebase_evm_pectra_activation.py --legacy-wallet',
    'runebase_evm_pectra_historical_data.py',
    'feature_pruning.py',
    'feature_dbcrash.py',
...
BASE_SCRIPTS = [
    ...
    'runebase_evm_pectra_precompiles.py --legacy-wallet',
    'runebase_evm_pectra_precompiles.py --descriptors',
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("^(example|feature|interface|mempool|mining|p2p|rpc|wallet|tool|runebase)_")
