...
class RunebaseP2PPunishInvalidContractTxTest(BitcoinTestFramework):
    ...
    def test_invalid_sender_script_punishment(self):
        ...
        bad_tx.vout = [CTxOut(0, CScript([b"\x04", CScriptNum(1000000), CScriptNum(RUNEBASE_MIN_GAS_PRICE), b"\x00", OP_CREATE]))]
    ...
    def test_gas_exceeds_limit_punishment(self):
        ...
        bad_tx.vout = [
            CTxOut(0, CScript([b"\x04", CScriptNum(19998999), CScriptNum(RUNEBASE_MIN_GAS_PRICE), hex_str_to_bytes("00"), hex_str_to_bytes(contract_address), OP_CALL])),
            CTxOut(0, CScript([b"\x04", CScriptNum(19998999), CScriptNum(RUNEBASE_MIN_GAS_PRICE), hex_str_to_bytes("00"), hex_str_to_bytes(contract_address), OP_CALL])),
            CTxOut(0, CScript([b"\x04", CScriptNum(19998999), CScriptNum(RUNEBASE_MIN_GAS_PRICE), hex_str_to_bytes("00"), hex_str_to_bytes(contract_address), OP_CALL])),
        ]
...
if __name__ == '__main__':
    RunebaseP2PPunishInvalidContractTxTest(__file__).main()
