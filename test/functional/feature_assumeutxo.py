...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test runebased should fail when mempool not empty.")
        node=self.nodes[2]
    ...
    def test_invalid_file_path(self):
        self.log.info("Test runebased should fail when file path is invalid.")
        node = self.nodes[0]
    ...
    def test_snapshot_with_less_work(self, dump_output_path):
        self.log.info("Test runebased should fail when snapshot has less accumulated work than this node.")
        node = self.nodes[0]
    ...
    def assert_disk_cleanup(self, node, assumeutxo_used):
        ...
        are disabled because Runebase's CheckSync checkpoint (validation.cpp:6331)
    ...
    def run_test(self):
        ...
        # which is blocked by Runebase's CheckSync checkpoint. See comment on
        ...
        # Disabled: background validation is blocked by Runebase's CheckSync
