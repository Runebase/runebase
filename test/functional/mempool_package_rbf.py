...
class PackageRBFTest(BitcoinTestFramework):
    ...
    def test_wrong_conflict_cluster_size_linear(self):
        ...
        # (CompareIteratorByHash in kernel/mempool_entry.h). Runebase transactions
        ...
        # In Runebase, the child tx has the lowest hash in this cluster.
    ...
    def test_wrong_conflict_cluster_size_parents_child(self):
        ...
        # Now make conflicting packages for each coin.
        # In Runebase, parent1 and parent2 both have lower hashes than child,
    ...
    def test_wrong_conflict_cluster_size_parent_children(self):
        ...
        # In Runebase, child2 has the lowest hash in the cluster, so
