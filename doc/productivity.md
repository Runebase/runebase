...
```sh
cmake --build build --target runebased runebase-cli
cmake --build build --target runebase-qt
cmake --build build --target bench_runebase
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:runebase/runebase.git
```
...
> e.g. github.com/runebase/runebase.git
