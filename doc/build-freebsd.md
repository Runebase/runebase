...
#### Wallet Dependencies
It is not necessary to build wallet functionality to run either `runebased` or `runebase-qt`.
...
```
to: /path/to/runebase/depends/x86_64-unknown-freebsd[release-number]
```
