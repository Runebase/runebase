...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *runebase-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *runebase-qt* and *runebase-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *runebase-node* and *runebase-gui* executables to communicate when [`-DENABLE_IPC=ON`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *runebased* and *runebase-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *runebased* and *runebase-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *runebase-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *runebased* and *runebase-qt* executables. |
...
runebase-cli[runebase-cli]-->libbitcoin_cli;

runebased[runebased]-->libbitcoin_node;
runebased[runebased]-->libbitcoin_wallet;

runebase-qt[runebase-qt]-->libbitcoin_node;
runebase-qt[runebase-qt]-->libbitcoinqt;
runebase-qt[runebase-qt]-->libbitcoin_wallet;

runebase-wallet[runebase-wallet]-->libbitcoin_wallet;
runebase-wallet[runebase-wallet]-->libbitcoin_wallet_tool;
...
class runebase-qt,runebased,runebase-cli,runebase-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different Runebase Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
