#ifndef RUNEBASEVERSIONCHECKER_H
#define RUNEBASEVERSIONCHECKER_H
...
class RunebaseVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit RunebaseVersionChecker(QObject *parent = 0);
    ~RunebaseVersionChecker();
...
#endif // RUNEBASEVERSIONCHECKER_H
