#ifndef RUNEBASEHWITOOL_H
#define RUNEBASEHWITOOL_H
...
/**
 * @brief The RunebaseHwiTool class Communicate with the Runebase Hardware Wallet Interface Tool
 */
class RunebaseHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief RunebaseHwiTool Constructor
     * @param parent Parent object
     */
    explicit RunebaseHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~RunebaseHwiTool Destructor
     */
    ~RunebaseHwiTool();
...
private:
    ...
    RunebaseHwiToolPriv* d;
};

#endif // RUNEBASEHWITOOL_H
