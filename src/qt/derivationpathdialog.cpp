    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(RunebaseHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(RunebaseHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(RunebaseHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(RunebaseHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(RunebaseHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(RunebaseHwiTool::derivationPathBech32());
