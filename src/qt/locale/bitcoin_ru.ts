...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Это ваши runebase-адреса для получения платежей. Используйте кнопку «Создать новый адрес для получения» на вкладке Получить, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Помните, что шифрование кошелька не может полностью защитить ваши runebases от кражи вредоносными программами, заражающими ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Введите runebase-адрес (напр. %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить средства на runebase-адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения вашими runebase-адресами, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверяйте сообщения, чтобы убедиться, что они подписаны конкретными runebase-адресами</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Runebase Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">%1 скачает и сохранит копию цепочки блоков runebase.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неверным. Информация станет верной после завершения синхронизации с сетью runebase, прогресс которой вы можете видеть ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Полный путь к сценарию, совместимому с Runebase Core (например, C:\Downloads\hwi.exe или /Users/you/Downloads/hwi.py). Осторожно: вредоносные программы могут украсть ваши монеты!</translation>
    </message>
    <message>
        ...
        <translation>Автоматически открыть порт runebase-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция на нём включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Автоматически открыть порт runebase-клиента на роутере. Работает? если ваш роутер поддерживает NAT-PMP, и данная функция на нём включена. Внешний порт может быть случайным.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключиться к сети runebase через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Подключаться к сети runebase через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Показанная информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью runebase после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
Если вы получили эту ошибку, вам следует попросить у продавца URI, совместимый с BIP21.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Не удалось обработать URI! Это может быть вызвано тем, что runebase-адрес неверен или параметры URI неправильно сформированы.</translation>
    </message>
    <message>
...
Примечание: так как комиссия рассчитывается пропорционально размеру в байтах, комиссия «100 сатоши за ВКБ» для транзакции размером 500 виртуальных байт (половина 1 ВКБ) приведет к сбору в размере всего 50 сатоши.</translation>
    ...
    <message>
        ...
        <translation type="unfinished">Пожалуйста, ещё раз просмотрите черновик вашей транзакции. Будет создана частично подписанная runebase-транзакция (PSBT), которую можно сохранить или скопировать, после чего подписать, например, офлайновым кошельком %1 или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Предупреждение: неверный runebase-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Комиссия будет вычтена из отправляемой суммы. Получателю придёт меньше runebaseов, чем вы ввели в поле «Сумма». Если выбрано несколько получателей, комиссия распределяется поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Сообщение, которое было прикреплено к URI и которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть runebase.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Вы можете подписывать сообщения/соглашения своими адресами, чтобы доказать, что вы можете получать runebases на них. Будьте осторожны и не подписывайте непонятные или случайные сообщения, так как мошенники могут таким образом пытаться присвоить вашу личность. Подписывайте только такие сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение runebase-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Проверить сообщение, чтобы убедиться, что оно действительно подписано указанным runebase-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s испорчен. Попробуйте восстановить с помощью инструмента runebase-wallet или восстановите из резервной копии.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка: версия дамп-файла не поддерживается. Эта версия runebase-wallet поддерживает только дамп-файлы версии 1. Обнаружено дамп-файл версии %s</translation>
    </message>
    <message>
