...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation>您可以用这些RUNEBASE地址收款。使用“接收”标签页中的"创建新收款地址"按钮创建新地址。
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s请求监听端口%u。这个端口被认为是“坏的”，因此任何RUNEBASE核心节点都不太可能连接到它。有关详细信息和完整列表，请参见 doc/p2p-bad-ports.md</translation>
    </message>
    <message>
