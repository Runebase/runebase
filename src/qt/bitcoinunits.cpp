...
{
    switch (unit) {
    case Unit::BTC: return QString("RUNES");
    case Unit::mBTC: return QString("CHUNKS");
    case Unit::uBTC: return QString::fromUtf8("CHIPS (bits)");
    case Unit::SAT: return QString("DUST (sat)");
...
QString BitcoinUnits::description(Unit unit)
{
    switch (unit) {
    case Unit::BTC: return QString("RUNES");
    case Unit::mBTC: return QString("CHUNKS (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("CHIPS (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("DUST (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
