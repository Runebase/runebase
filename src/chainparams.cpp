...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000012cae21c73d14f9b29e"); // runebase
        ...
        vSeeds.emplace_back("runebase3.dynu.net"); // Runebase mainnet
        vSeeds.emplace_back("runebase5.dynu.net"); // Runebase mainnet
        vSeeds.emplace_back("runebase6.dynu.net"); // Runebase mainnet
        vSeeds.emplace_back("runebase7.dynu.net"); // Runebase mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000047cc31541550003573"); // runebase
