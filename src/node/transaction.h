 ...
 */
static const CFeeRate DEFAULT_MAX_RAW_TX_FEE_RATE{100 * COIN};
 ...
 */
CTransactionRef GetTransaction(const CBlockIndex* const block_index, const CTxMemPool* const mempool, const Txid& hash, uint256& hashBlock, const BlockManager& blockman, Chainstate* chainstate = nullptr);
} // namespace node
