...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " runebase-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  runebase-tx [options] <hex-tx> [commands]  Update hex-encoded runebase transaction\n" +
            "or:     runebase-tx [options] -create [commands]   Create hex-encoded runebase transaction\n" +
            "\n";
