    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                fs::path runebaseStateDir = gArgs.GetDataDirNet() / "stateRunebase";
            ...
            try {
                ...
                globalSealEngine->setRunebaseSchedule(runebaseDGP.getGasSchedule(active_chain.Height() + (active_chain.Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
