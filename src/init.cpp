...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://runebase.io>";
...
void DeleteBlockChainData()
{
    ...
    fs::remove_all(GetDataDir() / "stateRunebase");
    ...
    while (!fLoaded && !ShutdownRequested()) {
        ...
        do {
            ...
            try {
                ...
                globalSealEngine->setRunebaseSchedule(runebaseDGP.getGasSchedule(::ChainActive().Height() + (::ChainActive().Height()+1 >= chainparams.GetConsensus().QIP7Height ? 0 : 1) ));
