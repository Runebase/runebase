...
void RunebaseDGP::initDataEIP158(){
...
bool RunebaseDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule RunebaseDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule RunebaseDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
