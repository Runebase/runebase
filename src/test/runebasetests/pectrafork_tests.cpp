...
BOOST_AUTO_TEST_CASE(checking_add_G1_bls_after_fork){
    ...
    txs.push_back(createRunebaseTransaction(getCode(CodeID::precompileCheckContract), 0, GASLIMIT, dev::u256(1), ++hashTx, dev::Address()));
    ...
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessAddG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailAddG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
...
BOOST_AUTO_TEST_CASE(checking_msm_G1_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessMsmG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailMsmG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_add_G2_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessAddG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailAddG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_msm_G2_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessMsmG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailMsmG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_pairing_check_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessPairingCheck), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailPairingCheck), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_map_fp_to_G1_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessMapFpToG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailMapFpToG1), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_map_fp2_to_G2_bls_after_fork){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txPectra;
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallSuccessMapFp2ToG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txPectra.push_back(createRunebaseTransaction(getCode(CodeID::verifyCallFailMapFp2ToG2), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txPectra, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_opcode_blockhash_and_history_blockhash_value){
    ...
    // Create contract
    std::vector<RunebaseTransaction> txs;
    txs.push_back(createRunebaseTransaction(getCode(CodeID::blockHashContract), 0, GASLIMIT, dev::u256(1), ++hashTx, dev::Address()));
    auto result = executeBC(txs, *m_node.chainman);
    BOOST_CHECK(result.first[0].execRes.excepted == dev::eth::TransactionException::None);
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txBlockHash;
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getBlockHash, nHeight), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeight), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightBeforePectra), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
...
BOOST_AUTO_TEST_CASE(checking_historical_precompile_contract_edges){
    ...
    dev::Address proxy = createRunebaseAddress(txs[0].getHashWith(), txs[0].getNVout());
    std::vector<RunebaseTransaction> txBlockHash;
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightTip), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightLast), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightAfterTip), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightBeforeLast), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txBlockHash, *m_node.chainman);
...
BOOST_AUTO_TEST_CASE(checking_historical_precompile_reorganize_blocks){
    ...
    std::vector<RunebaseTransaction> txCreateBlockHash;
    txCreateBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::blockHashContract), 0, GASLIMIT, dev::u256(1), ++hashTx, dev::Address()));
    ...
    dev::Address proxy = createRunebaseAddress(txCreateBlockHash[0].getHashWith(), txCreateBlockHash[0].getNVout());
    std::vector<RunebaseTransaction> txGetBlockHash;
    txGetBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightTip), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    ...
    std::vector<RunebaseTransaction> txAfterInvalidate;
    txAfterInvalidate.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightTip), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    result = executeBC(txGetBlockHash, *m_node.chainman);
    ...
    std::vector<RunebaseTransaction> txLastBlockHash;
    txLastBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightLast), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txLastBlockHash.push_back(createRunebaseTransaction(getCode(CodeID::getHistoricalBlockHash, nHeightBeforeLast), 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
