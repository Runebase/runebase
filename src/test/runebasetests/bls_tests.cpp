...
#include <test/runebasetests/data/add_G1_bls.json.h>
#include <test/runebasetests/data/fail_add_G1_bls.json.h>
#include <test/runebasetests/data/mul_G1_bls.json.h>
#include <test/runebasetests/data/fail_mul_G1_bls.json.h>
#include <test/runebasetests/data/msm_G1_bls.json.h>
#include <test/runebasetests/data/fail_msm_G1_bls.json.h>
#include <test/runebasetests/data/add_G2_bls.json.h>
#include <test/runebasetests/data/fail_add_G2_bls.json.h>
#include <test/runebasetests/data/mul_G2_bls.json.h>
#include <test/runebasetests/data/fail_mul_G2_bls.json.h>
#include <test/runebasetests/data/msm_G2_bls.json.h>
#include <test/runebasetests/data/fail_msm_G2_bls.json.h>
#include <test/runebasetests/data/pairing_check_bls.json.h>
#include <test/runebasetests/data/fail_pairing_check_bls.json.h>
#include <test/runebasetests/data/map_fp_to_G1_bls.json.h>
#include <test/runebasetests/data/fail_map_fp_to_G1_bls.json.h>
#include <test/runebasetests/data/map_fp2_to_G2_bls.json.h>
#include <test/runebasetests/data/fail_map_fp2_to_G2_bls.json.h>
