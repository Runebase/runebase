...
void checkChainid(dev::h256& hashTx, ChainstateManager& chainman, const ChainType chain, const runebaseutils::ChainIdType& chainId)
{
    // Select params
...
BOOST_AUTO_TEST_CASE(checking_shanghai_after_fork){
    ...
    checkChainid(hashTx, *m_node.chainman, ChainType::MAIN, runebaseutils::ChainIdType::MAIN);
    checkChainid(hashTx, *m_node.chainman, ChainType::TESTNET, runebaseutils::ChainIdType::TESTNET);
    checkChainid(hashTx, *m_node.chainman, ChainType::REGTEST, runebaseutils::ChainIdType::REGTEST);
...
BOOST_AUTO_TEST_CASE(checking_shanghai_before_fork){
    ...
    checkChainid(hashTx, *m_node.chainman, ChainType::MAIN, runebaseutils::ChainIdType::MAIN);
    checkChainid(hashTx, *m_node.chainman, ChainType::TESTNET, runebaseutils::ChainIdType::MAIN);
    checkChainid(hashTx, *m_node.chainman, ChainType::REGTEST, runebaseutils::ChainIdType::MAIN);
