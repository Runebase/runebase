...
////////////////////////////////////////////////////////////// runebase
    ...
    std::filesystem::path pathTemp = fs::temp_directory_path() / strprintf("test_runebase_%lu_%i", (unsigned long)GetTime(), (int)(g_rng_temp_path.randrange<unsigned>(100000)));
