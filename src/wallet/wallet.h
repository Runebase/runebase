...
private:
    ...
    void StakeRunebases(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking runebases */
    void StartStake(CConnman* connman) { StakeRunebases(true, connman); }

    /* Stop staking runebases */
    void StopStake() { StakeRunebases(false, 0); }
