...
////////////////////////////////////////////////////////////// // runebase
    void setRunebaseSchedule(EVMSchedule _runebaseSchedule) const { runebaseSchedule = _runebaseSchedule; }

    EVMSchedule& getRunebaseSchedule() const { return runebaseSchedule; }
...
private:
    ...
    mutable EVMSchedule runebaseSchedule; // runebase
