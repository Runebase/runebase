...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/runebase-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example runebase.conf file. if contrib/devtools/gen-bitcoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/runebase.conf" "${DISTNAME}/"
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/Runebase-Core.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
