...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/runebase.conf}
...
then
  ...
  echo -e "To safely generate a runebase.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example runebase.conf file in share/examples/'
...
# parse the output from runebased --help
