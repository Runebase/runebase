...
# Extract options
function __fish_runebase_tx_get_options
...
# Extract commands
function __fish_runebase_tx_get_commands
...
complete \
    --command runebase-tx \
    --condition "not __fish_runebase_seen_cmd (__fish_runebase_tx_get_commands --commandsonly)" \
    --arguments "(__fish_runebase_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command runebase-tx \
    --arguments "(__fish_runebase_tx_get_commands)" \
    --no-files
