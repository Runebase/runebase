...
complete --command runebase-qt --no-files

# Extract options
function __fish_runebaseqt_get_options
...
complete \
    --command runebase-qt \
    --arguments "(__fish_runebaseqt_get_options --nofiles)"
