...
complete --command runebased --no-files

# Extract options
function __fish_runebased_get_options
...
complete \
    --command runebased \
    --arguments "(__fish_runebased_get_options --nofiles)"
