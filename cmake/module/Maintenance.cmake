...
function(add_windows_deploy_target)
  if(MINGW AND TARGET runebase AND TARGET runebase-qt AND TARGET runebased AND TARGET runebase-cli AND TARGET runebase-tx AND TARGET runebase-wallet AND TARGET runebase-util AND TARGET test_runebase)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:runebase-tx> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:runebase-tx>
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET runebase-qt)
    set(macos_app "Runebase-Qt.app")
    ...
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Runebase-Qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component runebase-qt --prefix ${macos_app}/Contents/MacOS --strip
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:runebase-qt> ${macos_app}/Contents/MacOS/Runebase-Qt
